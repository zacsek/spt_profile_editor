...
- **Keep User's changes**: Re-read the files before updating, and incorporate and keep user's changes. If it's not feasible to keep them, ask the user before changing/removing.
